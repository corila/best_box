<?php
namespace TYPO3\CMS\BestBox\Hooks;
/***************************************************************
 *  Copyright notice
 *
 ...
 */
class TypoScriptTemplateBox implements \TYPO3\CMS\Core\SingletonInterface {

	/**
	 * Static template of this extension
	 */
	const SELF_DEVELOPMENT_TEMPLATE = 'EXT:best_box/Configuration/Development';
	 ...
	 *
	 * @return \TYPO3\CMS\BestBox\Hooks\TypoScriptTemplate
	 */
	public static function getInstance() {
		return \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstance('TYPO3\CMS\BestBox\Hooks\TypoScriptTemplateBox');
	}
