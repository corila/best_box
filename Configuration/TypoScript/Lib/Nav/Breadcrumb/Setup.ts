	...
	10 {
		...
		1 {
			NO {
				...
				allWrap = <li class="first">|<span class="glyphicon glyphicon-play"></span></li> |*| <li>|<span class="glyphicon glyphicon-play"></span></li> |*| <li>|<span class="glyphicon glyphicon-play"></span></li>
			}
